...
with img_col:
    ...
    image_path = Path(__file__).parent.parent / "test_data" / "DAPI_E14.5_2_ISAP02045520_20220407.tif"
    ...
    try:
        ...
        st.image(arr, caption="DAPI image", use_container_width=True, clamp=True)
    except Exception as e:
