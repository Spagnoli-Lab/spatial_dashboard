...
def render_home_page() -> None:
    ...
    - **🗺️ Spatial Data**: Spatial transcriptomics exploration  
    ...
    2. Select your sample (E12, E14, E17)  
    ...
    st.markdown(
    """
    For documentation, support, or feature requests:  
    - Review the repository README files  
    - Report issues or enhancements through the issue tracker  
    - Verify data formats before uploading  
    ...
    *Corresponding author:* **Francesca M. Spagnoli** — [francesca.spagnoli@kcl.ac.uk](mailto:francesca.spagnoli@kcl.ac.uk)
    ...
    st.header("👤 Dashboard Created By")
    st.markdown("**Siwanart Ma**")
